...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 09, 2022 lúc 04:02 PM
...
--
ALTER TABLE `comment`
  ADD CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`id_status`) REFERENCES `baiviet` (`id_status`),
  ADD CONSTRAINT `comment_ibfk_2` FOREIGN KEY (`id_nguoidung`) REFERENCES `users` (`id`);
