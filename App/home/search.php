...
include "php/func-search.php";
$user = search_user($conn, $key);
session_start();
    ...
    <div class="header">
           ...
           <div class="header-left">
            ...
            <div class="header-middle">
                  <div class="btn">
                          <button onclick="window.location.href='home.php'" data-tooltip="Home"><i class="fas fa-home"></i></i></button>
    ...
    Tìm kiếm cho từ khóa <b><?=$key?></b>
        <div class="box-sidebar">
            ...
            <div class="btn-setting">
               ...
               <div class="icon-setting" onclick="window.location.href='friend.php'">
    ...
    <div class="kq-tim-kiem">
			<?php if ($user == 0){ ?>
				<div class="alert alert-warning 
        	     ...
        	     role="alert">
        	     <br>
				  Người dùng <b>"<?=$key?>"</b> Không tồn tại
			  </div>
			<?php }else{ ?>
                <h5 class="fw-bold">Mọi người</h5>
			<div class="kq">
				<?php foreach ($user as $user) { ?>
                    <div class="avata"></div>
					<p class="fw-bold"><?=$user['firts_name']?> <?=$user['last_name']?></p>
                    <p class="add"><i class="fas fa-user-plus" href="#"></i></p>
                    <hr>
				</div>
				<?php } ?>
			</div>
